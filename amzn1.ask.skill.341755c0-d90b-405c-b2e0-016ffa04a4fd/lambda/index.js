...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to RockPaperScissor. What do you choose?';
    ...
    handle(handlerInput) {
        ...
        switch(result){
            ...
            case 'rockpaper':
                ...
                break;
            case 'rockscissor':
                speakOutput+="you played rock and i played scissor, you win!";
                break;
            case 'paperrock':
                speakOutput+="you played paper and i played rock, you win!";
                break;
            case 'paperpaper':
            ...
            case 'scissorrock':
                ...
                break;
            case 'scissorpaper':
                speakOutput+="you played scissor and i played paper, you win!";
                break;
            case 'scissorscissor':
